Create one horizontal animation strip for Codex pet `chii`, state `running-right`.
...
Identity: same pet in every frame: Chiikawa-inspired but original: tiny round white kawaii pet, soft plush/sticker feel, warm gray rounded ears, simple dot eyes, tiny mouth, rosy cheeks, small paws, gentle anxious-curious charm, no copied character markings or exact Chiikawa design.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: Clean Japanese kawaii sticker sprite style, soft ink outline, compact full-body silhouette, readable at 192x208, flat chroma-key background..
