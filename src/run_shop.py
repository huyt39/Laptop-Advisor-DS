...
from shop_configs import get_brand_url, get_load_more_selectors, get_product_link_selector


def main() -> None:
    parser = argparse.ArgumentParser(description="Simple runner for Anphat/FPT laptop crawling.")
    parser.add_argument("--shop", choices=["anphat", "fpt"], required=True, help="Shop name")
